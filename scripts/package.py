...
EXCLUDE_DIRS = {".git", ".venv", "node_modules", "__pycache__", ".pytest_cache", "raw"}
INCLUDE_ROOTS = {"backend", "frontend", "data", "artifacts", "benchmarks", "docs", "scripts", "README.md", ".env.example", ".gitignore", "render.yaml"}
